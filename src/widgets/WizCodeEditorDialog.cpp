...
{
    m_codeBrowser->addObjectToJavaScriptClient("codeEditor", this);
    m_codeBrowser->addObjectToJavaScriptClient("external", m_external->publicAPIsObject()); //FIXME: Change the interface to minimized version.
